...
export const getUserOrderService = async (userId, searchQuery = null) => {
  try {
    let queryOptions = {
     ...
     include: [
  {
    ...
    return orders.map(order => ({
      ...
      order_status: order.order_status.charAt(0).toUpperCase() + order.order_status.slice(1).replace(/_/g, " "), // e.g., "Pending", "Shipped"
